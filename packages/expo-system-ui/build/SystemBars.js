...
function mergePropsStack(propsStack) {
    ...
    if (mergedEntry.statusBarHidden == null &&
 ...
 */
function createStackEntry({ hidden, style }) {
    return {
...
export class SystemBars extends Component {
    static _propsStack = [];
    ...
    static _applyStackEntry(entry, colorScheme) {
    ...
    static _updatePropsStack() {
        ...
        SystemBars._updateImmediate = setImmediate(() => {
            ...
            if (mergedProps != null) {
                ...
                if (oldProps?.statusBarHidden !== mergedProps.statusBarHidden ||
                    ...
                    SystemBars._applyStackEntry(mergedProps, mergedProps.statusBarStyle === 'auto' || mergedProps.navigationBarStyle === 'auto'
    ...
    static _onAppearanceChange({ colorScheme }) {
    ...
    static _appearanceSubscription = (() => {
        const subscription = customGlobal._appearanceSubscription ??
